 ...
 */
package com.github.shyiko.mysql.binlog.model.event;
...
public class EventHeaderV4 implements EventHeader {
    ...
    public long getEventLength() { return eventLength; }
    public void setEventLength(long eventLength) { this.eventLength = eventLength; }
    public long getPosition() { return nextPosition - eventLength; }
    ...
    @Override
    public long getHeaderLength() { return 19; }

    @Override
    public long getDataLength() { return getEventLength() - getHeaderLength(); }
