...
import com.github.shyiko.mysql.binlog.deserialization.json.JsonBinary;
...
import com.github.shyiko.mysql.binlog.exception.MissingTableMapEventException;
import com.github.shyiko.mysql.binlog.io.ByteArrayInputStream;
import com.github.shyiko.mysql.binlog.model.type.ColumnType;
...
public abstract class AbstractRowsEventDataDeserializer<T extends EventData> implements EventDataDeserializer<T> {
    ...
    private final Map<Long, TableMapEventData> tableMapEventByTableId;  /* 表结构信息 */
    ...
    public AbstractRowsEventDataDeserializer(Map<Long, TableMapEventData> tableMapEventByTableId) { this.tableMapEventByTableId = tableMapEventByTableId; }
    void setDeserializeDateAndTimeAsLong(boolean value) { this.deserializeDateAndTimeAsLong = value; }
    void setMicrosecondsPrecision(boolean value) { this.microsecondsPrecision = value; }
    void setDeserializeCharAndBinaryAsByteArray(boolean value) { this.deserializeCharAndBinaryAsByteArray = value; }
